  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          to="/manager/team"
          className="group rounded-3xl border border-gray-200 bg-white p-6 hover:border-red-500/40 hover:bg-gray-50 transition-all"
        >
          ...
          <h2 className="text-2xl font-black mt-3 text-gray-900 group-hover:text-red-500 transition-colors">
